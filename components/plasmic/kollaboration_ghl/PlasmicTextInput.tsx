...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 8UuapZzmVgHc/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__ti2P4)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__cCi3X)}
              role={"img"}
            />
          ),
