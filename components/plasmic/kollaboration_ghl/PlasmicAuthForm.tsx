...
import sty from "./PlasmicAuthForm.module.css"; // plasmic-import: Cmp6cZABYZXt/css
...
export const PlasmicAuthForm__VariantProps = new Array<VariantPropType>();
