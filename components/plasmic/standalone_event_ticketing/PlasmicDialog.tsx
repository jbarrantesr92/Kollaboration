...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: FOee1RVFpgDY/css
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button___8Qvqp)}
                >
                  {"Show dialog"}
                </Button>
              ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___0RUz)}
              >
                <div
                  className={classNames(
                    projectcss.all,
