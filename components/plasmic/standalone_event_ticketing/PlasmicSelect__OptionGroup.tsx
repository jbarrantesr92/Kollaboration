...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: e4S8YE776jcL/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: iiMExIyx9xlD/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__asini)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__fjl0I)}
              />
            </React.Fragment>
          ),
          value: args.children
