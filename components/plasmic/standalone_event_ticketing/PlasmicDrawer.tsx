...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: TYvzrA570afD/css
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__jCool)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
    ...
    >
      ...
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__vYntC)}
        >
          <DialogTitle
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__gAkeh)}
              >
                <div
                  className={classNames(
                    projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__laKtf)}>
            {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
              (() => {
                try {
                  return $ctx.purchased_tickets;
                } catch (e) {
                  if (
...
const PlasmicDescendants = {
  dialog: ["dialog", "drawerContent", "dialogTitle", "text", "dialogClose"],
  drawerContent: ["drawerContent", "dialogTitle", "text", "dialogClose"],
