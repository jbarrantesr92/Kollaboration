...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: KfDAmu4lid5o/css
...
export type PlasmicTextInput__VariantsArgs = {
  ...
  color?: SingleChoiceArg<"dark" | "softSand">;
};
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__k5Ymt)}
              role={"img"}
            />
          ),
      ...
      <input
        ...
        className={classNames(projectcss.all, projectcss.input, sty.input, {
          ...
          [sty.inputcolor_softSand]: hasVariant($state, "color", "softSand"),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___2BuAt)}
              role={"img"}
            />
          ),
